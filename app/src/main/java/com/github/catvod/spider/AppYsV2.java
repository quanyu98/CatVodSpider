...
public class AppYsV2 extends Spider {
 ...
 v.put("vod_content", vObj.has("vod_content") ? vObj.getString("vod_content") : getVodContent(vObj.getString("nextlink")));
 videos.put(v);
 }
        } else {
 ...
 v.put("vod_content", vObj.has("vod_content") ? vObj.getString("vod_content") : getVodContent(vid));
 videos.put(v);
 }
            }
        }
 ...
 result.put("list", videos);
    ...
    private String getVodContent(String vid) {
        try {
            String detailContent = detailContent(Arrays.asList(vid));
 JSONObject jsonObject = new JSONObject(detailContent);
 JSONArray jsonArray = jsonObject.getJSONArray("list");
 JSONObject videoObject = jsonArray.getJSONObject(0);
 String vodContent = videoObject.getString("vod_content");
 System.out.println("vodContent==" + vodContent);
            return vodContent;
 } catch (Exception e) {
            e.printStackTrace();
 }
